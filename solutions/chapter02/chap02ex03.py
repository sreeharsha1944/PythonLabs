...
""" A Solution For Chapter 2 Exercise 3
    ...
    • Determine and print the following information about
      the string:
    • Does it end in a period?
    • Does it contain all alphabetic characters?
    • Is there an 'x' in the string?
    • Create and print a new string that has all occurrences
      of 'e' changed to 'E'.
"""
...
print("The text with all occurrences of", original,
